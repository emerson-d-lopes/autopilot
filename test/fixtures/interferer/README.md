...
Load it next to the Lantern extension with `--load-extension=<lantern>,<this folder>` (see `tools/browser.js`), or through chrome://extensions with Developer mode on. Never load it in a real profile.
