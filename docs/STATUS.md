...
State of the build as of 2026-09-04, extension 0.2.0. 26 tools. The dated merge and verification notes from the build are in [history/2026-09-build-log.md](history/2026-09-build-log.md). Test counts and coverage are reported by CI on every push, see [CONTRIBUTING.md](../CONTRIBUTING.md).
